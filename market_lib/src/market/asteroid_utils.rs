...
impl Asteroid {
    ...
    pub fn try_from_asteroid(
        value: TypeId,
                ...
                match *value {
            22    => Ok(Self::ArkonorIGrade),
            17425 => Ok(Self::ArkonorIIGrade),
            17426 => Ok(Self::ArkonorIIIGrade),
            46678 => Ok(Self::ArkonorIVGrade),
            62568 => Ok(Self::CompressedArkonorIGrade),
            62569 => Ok(Self::CompressedArkonorIIGrade),
            62570 => Ok(Self::CompressedArkonorIIIGrade),
            62571 => Ok(Self::CompressedArkonorIVGrade),

            52316 => Ok(Self::BezdnacineIGrade),
            56627 => Ok(Self::BezdnacineIIGrade),
            56628 => Ok(Self::BezdnacineIIIGrade),
            62576 => Ok(Self::CompressedBezdnacineIGrade),
            62577 => Ok(Self::CompressedBezdnacineIIGrade),
            62578 => Ok(Self::CompressedBezdnacineIIIGrade),

            1223  => Ok(Self::BistotIGrade),
            17428 => Ok(Self::BistotIIGrade),
            17429 => Ok(Self::BistotIIIGrade),
            46676 => Ok(Self::BistotIVGrade),
            62564 => Ok(Self::CompressedBistotIGrade),
            62565 => Ok(Self::CompressedBistotIIGrade),
            62566 => Ok(Self::CompressedBistotIIIGrade),
            62567 => Ok(Self::CompressedBistotIVGrade),

            1225  => Ok(Self::CrokiteIGrade),
            17432 => Ok(Self::CrokiteIIGrade),
            17433 => Ok(Self::CrokiteIIIGrade),
            46677 => Ok(Self::CrokiteIVGrade),
            62560 => Ok(Self::CompressedCrokiteIGrade),
            62561 => Ok(Self::CompressedCrokiteIIGrade),
            62562 => Ok(Self::CompressedCrokiteIIIGrade),
            62563 => Ok(Self::CompressedCrokiteIVGrade),

            1232  => Ok(Self::DarkOchreIGrade),
            17436 => Ok(Self::OchreIIGrade),
            17437 => Ok(Self::OchreIIIGrade),
            46675 => Ok(Self::OchreIVGrade),
            62556 => Ok(Self::CompressedDarkOchreIGrade),
            62557 => Ok(Self::CompressedOchreIIGrade),
            62558 => Ok(Self::CompressedOchreIIIGrade),
            62559 => Ok(Self::CompressedOchreIVGrade),

            74533 => Ok(Self::DuciniumIGrade),
            74534 => Ok(Self::DuciniumIIGrade),
            74535 => Ok(Self::DuciniumIIIGrade),
            74536 => Ok(Self::DuciniumIVGrade),
            75287 => Ok(Self::CompressedDuciniumIGrade),
            75288 => Ok(Self::CompressedDuciniumIIGrade),
            75289 => Ok(Self::CompressedDuciniumIIIGrade),
            75290 => Ok(Self::CompressedDuciniumIVGrade),

            74529 => Ok(Self::EifyriumIGrade),
            74530 => Ok(Self::EifyriumIIGrade),
            74531 => Ok(Self::EifyriumIIIGrade),
            74532 => Ok(Self::EifyriumIVGrade),
            75283 => Ok(Self::CompressedEifyriumIGrade),
            75284 => Ok(Self::CompressedEifyriumIIGrade),
            75285 => Ok(Self::CompressedEifyriumIIIGrade),
            75286 => Ok(Self::CompressedEifyriumIVGrade),

            1229  => Ok(Self::GneissIGrade),
            17865 => Ok(Self::GneissIIGrade),
            17866 => Ok(Self::GneissIIIGrade),
            46679 => Ok(Self::GneissIVGrade),
            62552 => Ok(Self::CompressedGneissIGrade),
            62553 => Ok(Self::CompressedGneissIIGrade),
            62554 => Ok(Self::CompressedGneissIIIGrade),
            62555 => Ok(Self::CompressedGneissIVGrade),


            81975 => Ok(Self::GriemeerIGrade),
            81976 => Ok(Self::GriemeerIIGrade),
            81977 => Ok(Self::GriemeerIIIGrade),
            81978 => Ok(Self::GriemeerIVGrade),
            82316 => Ok(Self::CompressedGriemeerIGrade),
            82317 => Ok(Self::CompressedGriemeerIIGrade),
            82318 => Ok(Self::CompressedGriemeerIIIGrade),
            82319 => Ok(Self::CompressedGriemeerIVGrade),

            21    => Ok(Self::HedbergiteIGrade),
            17440 => Ok(Self::HedbergiteIIGrade),
            17441 => Ok(Self::HedbergiteIIIGrade),
            46680 => Ok(Self::HedbergiteIVGrade),
            62548 => Ok(Self::CompressedHedbergiteIGrade),
            62549 => Ok(Self::CompressedHedbergiteIIGrade),
            62550 => Ok(Self::CompressedHedbergiteIIIGrade),
            62551 => Ok(Self::CompressedHedbergiteIVGrade),

            1231  => Ok(Self::HemorphiteIGrade),
            17444 => Ok(Self::HemorphiteIIGrade),
            17445 => Ok(Self::HemorphiteIIIGrade),
            46681 => Ok(Self::HemorphiteIVGrade),
            62544 => Ok(Self::CompressedHemorphiteIGrade),
            62545 => Ok(Self::CompressedHemorphiteIIGrade),
            62546 => Ok(Self::CompressedHemorphiteIIIGrade),
            62547 => Ok(Self::CompressedHemorphiteIVGrade),

            82163 => Ok(Self::HezorimeIGrade),
            82164 => Ok(Self::HezorimeIIGrade),
            82165 => Ok(Self::HezorimeIIIGrade),
            82166 => Ok(Self::HezorimeIVGrade),
            82312 => Ok(Self::CompressedHezorimeIGrade),
            82313 => Ok(Self::CompressedHezorimeIIGrade),
            82314 => Ok(Self::CompressedHezorimeIIIGrade),
            82315 => Ok(Self::CompressedHezorimeIVGrade),

            1226  => Ok(Self::JaspetIGrade),
            17448 => Ok(Self::JaspetIIGrade),
            17449 => Ok(Self::JaspetIIIGrade),
            46682 => Ok(Self::JaspetIVGrade),
            62540 => Ok(Self::CompressedJaspetIGrade),
            62541 => Ok(Self::CompressedJaspetIIGrade),
            62542 => Ok(Self::CompressedJaspetIIIGrade),
            62543 => Ok(Self::CompressedJaspetIVGrade),


            20    => Ok(Self::KerniteIGrade),
            17452 => Ok(Self::KerniteIIGrade),
            17453 => Ok(Self::KerniteIIIGrade),
            46683 => Ok(Self::KerniteIVGrade),
            62536 => Ok(Self::CompressedKerniteIGrade),
            62537 => Ok(Self::CompressedKerniteIIGrade),
            62538 => Ok(Self::CompressedKerniteIIIGrade),
            62539 => Ok(Self::CompressedKerniteIVGrade),

            81900 => Ok(Self::KylixiumIGrade),
            81901 => Ok(Self::KylixiumIIGrade),
            81902 => Ok(Self::KylixiumIIIGrade),
            81903 => Ok(Self::KylixiumIVGrade),
            82300 => Ok(Self::CompressedKylixiumIGrade),
            82301 => Ok(Self::CompressedKylixiumIIGrade),
            82302 => Ok(Self::CompressedKylixiumIIIGrade),
            82303 => Ok(Self::CompressedKylixiumIVGrade),

            11396 => Ok(Self::MercoxitIGrade),
            17869 => Ok(Self::MercoxitIIGrade),
            17870 => Ok(Self::MercoxitIIIGrade),
            62586 => Ok(Self::CompressedMercoxitIGrade),
            62587 => Ok(Self::CompressedMercoxitIIGrade),
            62588 => Ok(Self::CompressedMercoxitIIIGrade),

            74521 => Ok(Self::MorduniumIGrade),
            74522 => Ok(Self::MorduniumIIGrade),
            74523 => Ok(Self::MorduniumIIIGrade),
            74524 => Ok(Self::MorduniumIVGrade),
            75275 => Ok(Self::CompressedMorduniumIGrade),
            75276 => Ok(Self::CompressedMorduniumIIGrade),
            75277 => Ok(Self::CompressedMorduniumIIIGrade),
            75278 => Ok(Self::CompressedMorduniumIVGrade),

            82016 => Ok(Self::NocxiteIGrade),
            82017 => Ok(Self::NocxiteIIGrade),
            82018 => Ok(Self::NocxiteIIIGrade),
            82019 => Ok(Self::NocxiteIVGrade),
            82304 => Ok(Self::CompressedNocxiteIGrade),
            82305 => Ok(Self::CompressedNocxiteIIGrade),
            82306 => Ok(Self::CompressedNocxiteIIIGrade),
            82307 => Ok(Self::CompressedNocxiteIVGrade),

            1227  => Ok(Self::OmberIGrade),
            17867 => Ok(Self::OmberIIGrade),
            17868 => Ok(Self::OmberIIIGrade),
            46684 => Ok(Self::OmberIVGrade),
            62532 => Ok(Self::CompressedOmberIGrade),
            62533 => Ok(Self::CompressedOmberIIGrade),
            62534 => Ok(Self::CompressedOmberIIIGrade),
            62535 => Ok(Self::CompressedOmberIVGrade),

            18    => Ok(Self::PlagioclaseIGrade),
            17455 => Ok(Self::PlagioclaseIIGrade),
            17456 => Ok(Self::PlagioclaseIIIGrade),
            46685 => Ok(Self::PlagioclaseIVGrade),
            62528 => Ok(Self::CompressedPlagioclaseIGrade),
            62529 => Ok(Self::CompressedPlagioclaseIIGrade),
            62530 => Ok(Self::CompressedPlagioclaseIIIGrade),
            62531 => Ok(Self::CompressedPlagioclaseIVGrade),

            1224  => Ok(Self::PyroxeresIGrade),
            17459 => Ok(Self::PyroxeresIIGrade),
            17460 => Ok(Self::PyroxeresIIIGrade),
            46686 => Ok(Self::PyroxeresIVGrade),
            62524 => Ok(Self::CompressedPyroxeresIGrade),
            62525 => Ok(Self::CompressedPyroxeresIIGrade),
            62526 => Ok(Self::CompressedPyroxeresIIIGrade),
            62527 => Ok(Self::CompressedPyroxeresIVGrade),

            52315 => Ok(Self::RakoveneIGrade),
            56629 => Ok(Self::RakoveneIIGrade),
            56630 => Ok(Self::RakoveneIIIGrade),
            62579 => Ok(Self::CompressedRakoveneIGrade),
            62580 => Ok(Self::CompressedRakoveneIIGrade),
            62581 => Ok(Self::CompressedRakoveneIIIGrade),

            1228  => Ok(Self::ScorditeIGrade),
            17463 => Ok(Self::ScorditeIIGrade),
            17464 => Ok(Self::ScorditeIIIGrade),
            46687 => Ok(Self::ScorditeIVGrade),
            62520 => Ok(Self::CompressedScorditeIGrade),
            62521 => Ok(Self::CompressedScorditeIIGrade),
            62522 => Ok(Self::CompressedScorditeIIIGrade),
            62523 => Ok(Self::CompressedScorditeIVGrade),

            19    => Ok(Self::SpodumainIGrade),
            17466 => Ok(Self::SpodumainIIGrade),
            17467 => Ok(Self::SpodumainIIIGrade),
            46688 => Ok(Self::SpodumainIVGrade),
            62572 => Ok(Self::CompressedSpodumainIGrade),
            62573 => Ok(Self::CompressedSpodumainIIGrade),
            62574 => Ok(Self::CompressedSpodumainIIIGrade),
            62575 => Ok(Self::CompressedSpodumainIVGrade),

            52306 => Ok(Self::TalassoniteIGrade),
            56625 => Ok(Self::TalassoniteIIGrade),
            56626 => Ok(Self::TalassoniteIIIGrade),
            62582 => Ok(Self::CompressedTalassoniteIGrade),
            62583 => Ok(Self::CompressedTalassoniteIIGrade),
            62584 => Ok(Self::CompressedTalassoniteIIIGrade),

            82205 => Ok(Self::UeganiteIGrade),
            82206 => Ok(Self::UeganiteIIGrade),
            82207 => Ok(Self::UeganiteIIIGrade),
            82208 => Ok(Self::UeganiteIVGrade),
            82308 => Ok(Self::CompressedUeganiteIGrade),
            82309 => Ok(Self::CompressedUeganiteIIGrade),
            82310 => Ok(Self::CompressedUeganiteIIIGrade),
            82311 => Ok(Self::CompressedUeganiteIVGrade),

            1230  => Ok(Self::VeldsparIGrade),
            17470 => Ok(Self::VeldsparIIGrade),
            17471 => Ok(Self::VeldsparIIIGrade),
            46689 => Ok(Self::VeldsparIVGrade),
            62516 => Ok(Self::CompressedVeldsparIGrade),
            62517 => Ok(Self::CompressedVeldsparIIGrade),
            62518 => Ok(Self::CompressedVeldsparIIIGrade),
            62519 => Ok(Self::CompressedVeldsparIVGrade),

            74525 => Ok(Self::YtiriumIGrade),
            74526 => Ok(Self::YtiriumIIGrade),
            74527 => Ok(Self::YtiriumIIIGrade),
            74528 => Ok(Self::YtiriumIVGrade),
            75279 => Ok(Self::CompressedYtiriumIGrade),
            75280 => Ok(Self::CompressedYtiriumIIGrade),
            75281 => Ok(Self::CompressedYtiriumIIIGrade),
            75282 => Ok(Self::CompressedYtiriumIVGrade),

            // MoonGoo
            45492 => Ok(Self::Bitumens),
            46284 => Ok(Self::BrimfulBitumens),
            46285 => Ok(Self::GlisteningBitumens),
            62454 => Ok(Self::CompressedBitumens),
            62455 => Ok(Self::CompressedBrimfulBitumens),
            62456 => Ok(Self::CompressedGlisteningBitumens),

            45493 => Ok(Self::Coesite),
            46286 => Ok(Self::BrimfulCoesite),
            46287 => Ok(Self::GlisteningCoesite),
            62457 => Ok(Self::CompressedCoesite),
            62458 => Ok(Self::CompressedBrimfulCoesite),
            62459 => Ok(Self::CompressedGlisteningCoesite),

            45491 => Ok(Self::Sylvite),
            46282 => Ok(Self::BrimfulSylvite),
            46283 => Ok(Self::GlisteningSylvite),
            62460 => Ok(Self::CompressedSylvite),
            62461 => Ok(Self::CompressedBrimfulSylvite),
            62466 => Ok(Self::CompressedGlisteningSylvite),

            45490 => Ok(Self::Zeolites),
            46280 => Ok(Self::BrimfulZeolites),
            46281 => Ok(Self::GlisteningZeolites),
            62463 => Ok(Self::CompressedZeolites),
            62464 => Ok(Self::CompressedBrimfulZeolites),
            62467 => Ok(Self::CompressedGlisteningZeolites),

            45494 => Ok(Self::Cobaltite),
            46288 => Ok(Self::CopiousCobaltite),
            46289 => Ok(Self::TwinklingCobaltite),
            62474 => Ok(Self::CompressedCobaltite),
            62475 => Ok(Self::CompressedCopiousCobaltite),
            62476 => Ok(Self::CompressedTwinklingCobaltite),

            45495 => Ok(Self::Euxenite),
            46290 => Ok(Self::CopiousEuxenite),
            46291 => Ok(Self::TwinklingEuxenite),
            62471 => Ok(Self::CompressedEuxenite),
            62472 => Ok(Self::CompressedCopiousEuxenite),
            62473 => Ok(Self::CompressedTwinklingEuxenite),

            45497 => Ok(Self::Scheelite),
            46294 => Ok(Self::CopiousScheelite),
            46295 => Ok(Self::TwinklingScheelite),
            62468 => Ok(Self::CompressedScheelite),
            62469 => Ok(Self::CompressedCopiousScheelite),
            62470 => Ok(Self::CompressedTwinklingScheelite),

            45496 => Ok(Self::Titanite),
            46292 => Ok(Self::CopiousTitanite),
            46293 => Ok(Self::TwinklingTitanite),
            62477 => Ok(Self::CompressedTitanite),
            62478 => Ok(Self::CompressedCopiousTitanite),
            62479 => Ok(Self::CompressedTwinklingTitanite),

            45501 => Ok(Self::Chromite),
            46302 => Ok(Self::LavishChromite),
            46303 => Ok(Self::ShimmeringChromite),
            62480 => Ok(Self::CompressedChromite),
            62481 => Ok(Self::CompressedLavishChromite),
            62482 => Ok(Self::CompressedShimmeringChromite),

            45498 => Ok(Self::Otavite),
            46296 => Ok(Self::LavishOtavite),
            46297 => Ok(Self::ShimmeringOtavite),
            62483 => Ok(Self::CompressedOtavite),
            62484 => Ok(Self::CompressedLavishOtavite),
            62485 => Ok(Self::CompressedShimmeringOtavite),

            45499 => Ok(Self::Sperrylite),
            46298 => Ok(Self::LavishSperrylite),
            46299 => Ok(Self::ShimmeringSperrylite),
            62486 => Ok(Self::CompressedSperrylite),
            62487 => Ok(Self::CompressedLavishSperrylite),
            62488 => Ok(Self::CompressedShimmeringSperrylite),

            45500 => Ok(Self::Vanadinite),
            46300 => Ok(Self::LavishVanadinite),
            46301 => Ok(Self::ShimmeringVanadinite),
            62489 => Ok(Self::CompressedVanadinite),
            62490 => Ok(Self::CompressedLavishVanadinite),
            62491 => Ok(Self::CompressedShimmeringVanadinite),

            45502 => Ok(Self::Carnotite),
            46304 => Ok(Self::RepleteCarnotite),
            46305 => Ok(Self::GlowingCarnotite),
            62492 => Ok(Self::CompressedCarnotite),
            62493 => Ok(Self::CompressedRepleteCarnotite),
            62494 => Ok(Self::CompressedGlowingCarnotite),

            45506 => Ok(Self::Cinnabar),
            46310 => Ok(Self::RepleteCinnabar),
            46311 => Ok(Self::GlowingCinnabar),
            62495 => Ok(Self::CompressedCinnabar),
            62496 => Ok(Self::CompressedRepleteCinnabar),
            62497 => Ok(Self::CompressedGlowingCinnabar),

            45504 => Ok(Self::Pollucite),
            46308 => Ok(Self::RepletePollucite),
            46309 => Ok(Self::GlowingPollucite),
            62498 => Ok(Self::CompressedPollucite),
            62499 => Ok(Self::CompressedRepletePollucite),
            62500 => Ok(Self::CompressedGlowingPollucite),

            45503 => Ok(Self::Zircon),
            46306 => Ok(Self::RepleteZircon),
            46307 => Ok(Self::GlowingZircon),
            62501 => Ok(Self::CompressedZircon),
            62502 => Ok(Self::CompressedRepleteZircon),
            62503 => Ok(Self::CompressedGlowingZircon),

            45512 => Ok(Self::Loparite),
            46316 => Ok(Self::BountifulLoparite),
            46317 => Ok(Self::ShiningLoparite),
            62504 => Ok(Self::CompressedLoparite),
            62505 => Ok(Self::CompressedBountifulLoparite),
            62506 => Ok(Self::CompressedShiningLoparite),

            45511 => Ok(Self::Monazite),
            46314 => Ok(Self::BountifulMonazite),
            46315 => Ok(Self::ShiningMonazite),
            62507 => Ok(Self::CompressedMonazite),
            62508 => Ok(Self::CompressedBountifulMonazite),
            62509 => Ok(Self::CompressedShiningMonazite),

            45510 => Ok(Self::Xenotime),
            46312 => Ok(Self::BountifulXenotime),
            46313 => Ok(Self::ShiningXenotime),
            62510 => Ok(Self::CompressedXenotime),
            62511 => Ok(Self::CompressedBountifulXenotime),
            62512 => Ok(Self::CompressedShiningXenotime),

            45513 => Ok(Self::Ytterbite),
            46318 => Ok(Self::BountifulYtterbite),
            46319 => Ok(Self::ShiningYtterbite),
            62513 => Ok(Self::CompressedYtterbite),
            62514 => Ok(Self::CompressedBountifulYtterbite),
            62515 => Ok(Self::CompressedShiningYtterbite),

            _ => Err(format!("Invalid asteroid: {}", value))
        }
    }
}

impl TryFrom<TypeId> for Asteroid {
    type Error = String;
    ...
    fn try_from(value: TypeId) -> Result<Self, Self::Error> {
        match *value {
            ...
            39    => Ok(Self::Zydrine),
            40    => Ok(Self::Megacyte),
            11399 => Ok(Self::Morphite),

            16634 => Ok(Self::AtmosphericGases),
            16635 => Ok(Self::EvaporiteDeposits),
            16633 => Ok(Self::Hydrocarbons),
            16636 => Ok(Self::Silicates),

            16640 => Ok(Self::Cobalt),
            16639 => Ok(Self::Scandium),
            16638 => Ok(Self::Titanium),
            16637 => Ok(Self::Tungsten),

            16641 => Ok(Self::Chromium),
            16643 => Ok(Self::Cadmium),
            16644 => Ok(Self::Platinum),
            16642 => Ok(Self::Vanadium),

            16647 => Ok(Self::Caesium),
            16648 => Ok(Self::Hafnium),
            16646 => Ok(Self::Mercury),
            16649 => Ok(Self::Technetium),
            16652 => Ok(Self::Promethium),
            16651 => Ok(Self::Neodymium),
            16650 => Ok(Self::Dysprosium),
            16653 => Ok(Self::Thulium),

            // ice
            16264 => Ok(Self::BlueIce),
            ...
            28442 => Ok(Self::CompressedGlacialMassIVGrade),
            16265 => Ok(Self::WhiteGlaze),
            17976 => Ok(Self::WhiteGlazeIVGrade),
            28444 => Ok(Self::CompressedWhiteGlaze),
            28441 => Ok(Self::CompressedWhiteGlazeIVGrade),
            16267 => Ok(Self::DarkGlitter),
            28435 => Ok(Self::CompressedDarkGlitter),
            16268 => Ok(Self::Gelidus),
            28437 => Ok(Self::CompressedGelidus),
            16266 => Ok(Self::GlareCrust),
            28439 => Ok(Self::CompressedGlareCrust),
            16269 => Ok(Self::Krystallos),
            28440 => Ok(Self::CompressedKrystallos),
