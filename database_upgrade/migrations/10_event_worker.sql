...
CREATE TABLE IF NOT EXISTS job_detection_logs(
    id           UUID      NOT NULL DEFAULT gen_random_uuid(),
...
CREATE UNIQUE INDEX IF NOT EXISTS job_detection_logs_job_id ON job_detection_logs(job_id);

CREATE TABLE IF NOT EXISTS asset_blueprints (
    id                  UUID    NOT NULL DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS asset_blueprints_owner ON asset_blueprints (owner_id);
