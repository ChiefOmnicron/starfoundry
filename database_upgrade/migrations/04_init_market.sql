...
CREATE TABLE IF NOT EXISTS market_orders_latest (
...
CREATE INDEX IF NOT EXISTS market_orders_latest_typeid ON market_orders_latest(type_id);
CREATE UNIQUE INDEX IF NOT EXISTS market_orders_latest_orderid ON market_orders_latest(order_id);
