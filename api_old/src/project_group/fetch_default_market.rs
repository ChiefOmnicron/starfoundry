...
use sqlx::PgPool;
use starfoundry_libs_structures::StructureDatabase;
...
/// /project-groups/{projectGroupUuid}/defaults/markets
/// 
...
#[utoipa::path(
    get,
    operation_id = "project_groups_fetch_default_markets",
    path = "/project-groups/{projectGroupUuid}/defaults/markets",
    tag = "project-groups",
    params(
...
pub async fn fetch_default_market_api(
    pool:               PgPool,
    identity:           Identity,
    project_group_uuid: ProjectGroupUuid,
) -> Result<impl Reply, Rejection> {
    match fetch_default_markets(
        &pool,
