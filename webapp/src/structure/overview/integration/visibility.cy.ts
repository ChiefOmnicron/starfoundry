...
describe('Visibility', () => {
    it('should show the spinner', () => {
        ...
        cy.get('[data-cy="structuresLoaderInitial"]').should('be.visible');

        cy.get('[data-cy="structureLoadingError"]').should('not.exist');
        cy.get('[data-cy="structuresNoEntries"]').should('not.exist');
        cy.get('[data-cy="structuresFilter"]').should('not.exist');
        cy.get('[data-cy="structuresActionGroup"]').should('not.exist');
        cy.get('[data-cy="structuresLoaderApi"]').should('not.exist');
        cy.get('[data-cy="structuresEmptyNoSearchResult"]').should('not.exist');
        cy.get('[data-cy="structuresDataTable"]').should('not.exist');
    });
    ...
    it('should show no structures and have the option to create one', () => {
        ...
        cy.get('[data-cy="structuresNoEntries"]').should('be.visible');
        cy.get('[data-cy="structuresNoEntriesAddButton"]').should('be.visible');

        cy.get('[data-cy="structureLoadingError"]').should('not.exist');
        cy.get('[data-cy="structuresLoaderInitial"]').should('not.exist');
        cy.get('[data-cy="structuresFilter"]').should('not.exist');
        cy.get('[data-cy="structuresActionGroup"]').should('not.exist');
        cy.get('[data-cy="structuresLoaderApi"]').should('not.exist');
        cy.get('[data-cy="structuresEmptyNoSearchResult"]').should('not.exist');
    ...
    it('should show the initial loading error message', () => {
        ...
        cy.get('[data-cy="structureLoadingError"]').should('be.visible');

        cy.get('[data-cy="structuresNoEntries"]').should('not.exist');
        cy.get('[data-cy="structuresNoEntriesAddButton"]').should('not.exist');
        cy.get('[data-cy="structuresLoaderInitial"]').should('not.exist');
        cy.get('[data-cy="structuresFilter"]').should('not.exist');
        cy.get('[data-cy="structuresActionGroup"]').should('not.exist');
        cy.get('[data-cy="structuresLoaderApi"]').should('not.exist');
    ...
    it('should show one item', () => {
        ...
        cy.get('[data-cy="structuresFilter"]').should('be.visible');
        cy.get('[data-cy="structuresActionGroup"]').should('be.visible');
        cy.get('[data-cy="structuresDataTable"]').should('be.visible');
