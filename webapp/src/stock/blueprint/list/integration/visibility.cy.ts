...
describe('Visibility', () => {
    it('should show the spinner', () => {
        ...
        cy
            .get('[data-cy="stockBlueprintLoaderInitial"]')
            .should('be.visible');

        cy
            .get('[data-cy="stockBlueprintLoadingError"]')
            .should('not.exist');
        cy
            .get('[data-cy="stockBlueprintNoEntries"]')
            .should('not.exist');
        cy
            .get('[data-cy="stockBlueprintFilter"]')
            .should('not.exist');
        cy
            .get('[data-cy="stockBlueprintActionGroup"]')
            .should('not.exist');
        cy
            .get('[data-cy="stockBlueprintLoaderApi"]')
            .should('not.exist');
        cy
            .get('[data-cy="stockBlueprintEmptyNoSearchResult"]')
            .should('not.exist');
        cy
            .get('[data-cy="stockBlueprintDataTable"]')
            .should('not.exist');
    });
    ...
    it('should show no structures and have the option to create one', () => {
        ...
        cy
            ...
            .should('be.visible');
        cy
            .get('[data-cy="stockBlueprintNoEntriesAddButton"]')
            .should('be.visible');
