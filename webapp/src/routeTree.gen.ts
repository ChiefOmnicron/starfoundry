...
import { Route as StructuresCreateRouteImport } from './routes/structures/create'
...
const StructuresCreateRoute = StructuresCreateRouteImport.update({
  id: '/create',
  path: '/create',
  getParentRoute: () => StructuresRouteRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/structures/create': {
      ...
      preLoaderRoute: typeof StructuresCreateRouteImport
      parentRoute: typeof StructuresRouteRoute
    }
    '/project-groups/create': {
