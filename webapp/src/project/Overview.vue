...
import { Project, ProjectService, type IFinance, type IProduct } from '@/sdk/project';
...
class ProjectOverview extends Vue {
    ...
    public financeInfo(finance: IFinance) {
        return [{
            ...
            field:     'Total Cost',
            value:     finance.jobs + finance.market + finance.misc - finance.excess,
            is_number: true,
        }, {
            field:     'Sell price',
            ...
            field:     'Profit',
            value:     (finance.sell_price || 0) - (finance.jobs + finance.market + finance.misc - finance.excess),
            is_number: true,
        }];
    }
