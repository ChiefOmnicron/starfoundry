          ...
          <template v-for="j in jobs" :key="j.job_id">
            <tr>
              ...
              <td>
                ...
                <format-number v-if="(j.remaining || 0) > 0" :value="j.remaining || 0" time />
              </td>
              <td>
                <n-button
                  text
              ...
              <td>
                <character-info v-if="!j.corporation_id" :character-id="j.installer_id">
                ...
                <div v-if="j.corporation_id">
                  <corporation-info :corporation-id="j.corporation_id">
                    <template v-slot="{ info }">
                      {{ info.corporation }}
                    </template>
                  </corporation-info>
                  <character-info :character-id="j.installer_id">
                    <template v-slot="{ info }">
                      {{ info.character }}
                    </template>
                  </character-info>
...
import { NButton, NCard, NCountdown, NSpace, NTable, NTag, NText } from 'naive-ui';
