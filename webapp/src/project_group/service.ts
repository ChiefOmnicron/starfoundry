...
export class ProjectGroupService {
    ...
    public static async fetch(
        ...
        if (
            this.cache[groupId] &&
            this.cache[groupId].is_deep_loaded
        ) {
...
export class ProjectGroupMemberService {
    public static async members(
        groupId: Uuid,
    ): Promise<IProjectGroupMember[]> {
        return axios.get(
            `${PROJECT_GROUP_PATH}/${groupId}/members`,
        )
        .then(x => x.data);
    }
    ...
    public static async accept(
        ...
        .then(_ => { delete ProjectGroupService.cache[groupId] });
    }
...
export class ProjectGroup {
    ...
    public constructor(
        private _projectGroupId: ProjectGroupId,
    ) {
        this.loader = axios
    ...
    public deepInfo() {
        ...
        this.loader = Promise
            .all(
                [
                    `${PROJECT_GROUP_PATH}/${this._projectGroupId}/members`,
                ]
            ...
            .then(axios.spread((
                    ...
                    this._members = (<AxiosResponse<IProjectGroupMember[]>> members).data;
                })
            )
            .then(_ => this.loader = null)
    ...
    public async updateDefault(
        ...
        return await axios.put(`${PROJECT_GROUP_PATH}/${this.id}/default`, defaults)
    }
}
