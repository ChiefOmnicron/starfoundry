...
export class ProjectService {
    ...
    public static async list(filter: IProjectFilter): Promise<Project[]> {
        return await axios
    ...
    public static async fetch(projectId: ProjectUuid): Promise<Project> {
    ...
    public static async create_job_assignment(job_ids: Uuid[]): Promise<Uuid> {
        return axios
    ...
    public static async update_job_assignment(
        ...
        return axios
            .put(
                `${PROJECT_PATH_JOB_ASSIGNMENTS}/${assignment_id}/${job_id}/state`,
            )
            .then((x) => x.data);
    }
    ...
    public static async check_resources(
        ...
        return axios.post(`${PROJECT_PATH}/check`, check).then((x) => x.data);
    }

    public static async create(project: ICreateProject): Promise<ProjectUuid> {
        return axios.post(`${PROJECT_PATH}`, project).then((x) => x.data);
    }

    public static async lastMarketFetch(structureId: Uuid): Promise<string> {
        return axios
...
export class Project {
    ...
    public constructor(private _projectId: ProjectUuid) {
        this.loader = axios
            ...
            .then(
                axios.spread(
                    (
                        ...
                        this._market = (<AxiosResponse<IMarketGroup[]>>(
                            market
                        )).data;
    ...
    public async fetchJobsGrouped(
        filter: IFetchJobFilter,
    ): Promise<IJobGroup[]> {
        return axios
            .get(`${PROJECT_PATH}/${this._projectId}/jobs`, {
                params: {
    ...
    public async updateJob(jobId: JobUuid, job: IJob): Promise<void> {
        return axios
            .put(`${PROJECT_PATH}/${this._projectId}/jobs/${jobId}`, job)
            .then((x) => x.data);
    }

    public addMarket(entry: IMarket): Promise<void> {
        return axios.post(`${PROJECT_PATH}/${this._projectId}/market`, entry);
    }
    ...
    public async updateExcessPrices(
        ...
        return axios
            .put(`${PROJECT_PATH}/${this._projectId}/excess/prices`, {
    ...
    public async updateStockPrices(
        ...
        return axios
            .put(`${PROJECT_PATH}/${this._projectId}/stocks/prices`, {
                appraisal: selectedAppraisal,
            })
    ...
    public async updateCompressedOre(
        ...
        return axios.put(
            `${PROJECT_PATH}/${this._projectId}/market/minerals`,
            compressed,
        );
    }
    ...
    public async saveSettings(): Promise<any> {
        return axios.put(`${this.PROJECT_PATH}/${this.id}`, {
    ...
    get minerals(): IMarket[] {
        ...
        if (entries) {
            return entries.entries.filter((x: any) => x.type_id !== 11399);
        } else {
            return [];
        }
    }
