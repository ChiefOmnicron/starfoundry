...
use starfoundry_lib_market::ENV_MARKET_API;
use tokio::net::TcpListener;

const ENV_DATABASE_URL: &str     = "STARFOUNDRY_APPRAISAL_DATABASE_URL";
const ENV_APP_ADDRESS: &str      = "STARFOUNDRY_APPRAISAL_APP_ADDRESS";
const ENV_SERVICE_ADDRESS: &str  = "STARFOUNDRY_APPRAISAL_SERVICE_ADDRESS";
