use sqlx::PgPool;
use starfoundry_libs_projects::{ProjectGroupUuid, ProjectGroupMember, ProjectGroupService};
...
#[utoipa::path(
    ...
    path = "/api/v1/project-groups/{projectGroupUuid}/members",
    tag = "project-groups",
    params(
...
pub async fn fetch_members(
    ...
    match project_group.fetch_members(
        &pool,
