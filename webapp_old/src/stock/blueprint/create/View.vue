<template>
    <div>
        ...
        <loader :busy="busy" data-cy="stockBlueprintCreateLoading" />
        ...
        <card title="Notifications" v-if="!busy">
            <notification :notifications="notifications" />
        </card>

        <card-margin />

        <card title="Title" v-if="!busy">
            <template #action>
                <n-button
                    type="info"
        ...
        <action-group data-cy="structureUpdateActions">
