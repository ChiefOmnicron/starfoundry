use sqlx::PgPool;
use starfoundry_lib_structures::{StructureGroupUuid, StructureService};
use starfoundry_lib_types::CharacterId;

use crate::engine::{ProjectStructureGroup, StructureMapping};
...
async fn structure_group(
    ...
    character_id: CharacterId,
    group_id:     StructureGroupUuid,
) -> Result<Option<ProjectStructureGroup>, Box<dyn std::error::Error>> {
