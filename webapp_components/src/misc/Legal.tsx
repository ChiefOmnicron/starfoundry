export function LegalComponent() {
    return <div>
        ...
        <h2>Fenris Creations (formerly CCP Games)</h2>
        <span>
            ...
            rcimade.space to use EVE Online and all associated logos and
            designs for promotional and information purposes on its website but
            does not endorse, and is not in any way affiliated with,
            rcimade.space. CCP is in no way responsible for the content on
            or functioning of this website, nor can it be liable for any damage
