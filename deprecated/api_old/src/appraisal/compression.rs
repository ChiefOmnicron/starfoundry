use sqlx::PgPool;
use starfoundry_lib_appraisal::internal::{CompressionOptions, CompressionResult};
...
pub async fn compression(
    ...
    match starfoundry_lib_appraisal::internal::compression(
        &pool,
        code,
        options,
    ).await {
        ...
        Err(starfoundry_lib_appraisal::Error::NoSolution) => {
