...
use sqlx::PgPool;
use starfoundry_lib_appraisal::internal::{Appraisal, AppraisalOptions};
use utoipa::ToSchema;
...
use starfoundry_lib_appraisal::Persistance;
...
pub async fn create(
    ...
    match starfoundry_lib_appraisal::internal::create_raw(
        &pool,
        body.appraisal,
        Some(options)
    ).await {
