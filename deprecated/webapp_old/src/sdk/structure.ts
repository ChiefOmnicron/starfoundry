...
export class StructureService {
    ...
    public static async list(filter: IStructureFilter): Promise<Structure[]> {
        return await axios
    ...
    public static async fetch(structure_id: StructureId): Promise<Structure> {
    ...
    public static async create(structure: IStructure): Promise<Structure> {
        return axios
    ...
    public static async resolve(
        ...
        return (await axios.get(`${STRUCTURE_PATH}/${structure_id}/resolve`))
            .data;
    }
...
export class Structure {
    ...
    public constructor(private _structure_id: StructureId) {
    ...
    public async fetchPermissionCanWrite(): Promise<void> {
        await axios
            .get(
                `${STRUCTURE_PATH}/${this._structure_id}/permissions/can-write`,
            )
    ...
    public async update() {
        await axios.put(`${STRUCTURE_PATH}/${this._structure_id}`, this._info);
    }
