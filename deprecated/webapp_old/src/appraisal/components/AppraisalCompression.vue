    ...
    <n-table style="margin-bottom: 10px">
        ...
        <tr>
            ...
            <td style="text-align: left">
                <n-switch v-model:value="compression.allow_minerals">
                    <template #checked> Allow minerals </template>
                    <template #unchecked> Disallow minerals </template>
                </n-switch>
            </td>
            <td style="text-align: left">
                <n-switch v-model:value="compression.allow_uncompressed_gas">
                    <template #checked> Allow uncompressed gas </template>
                    <template #unchecked> Disallow uncompressed gas </template>
                </n-switch>
            </td>
        </tr>
        <tr>
            ...
            <td style="text-align: left">
                <n-switch v-model:value="compression.allow_uncompressed_ore">
                    <template #checked> Allow uncompressed ores </template>
                    <template #unchecked> Disallow uncompressed ores </template>
                </n-switch>
            </td>
            <td style="text-align: left">
                <n-switch v-model:value="compression.allow_uncompressed_moon">
                    <template #checked> Allow uncompressed moon ores </template>
                    <template #unchecked>
