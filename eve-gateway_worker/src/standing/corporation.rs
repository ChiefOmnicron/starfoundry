...
pub async fn corporation_standings(
    pool: &PgPool,
    ...
    let entries = match client
        ...
        Err(e) => {
            tracing::error!("Error while fetching corporation standings data, {:?}", e);
    ...
    sqlx::query!("
            ...
            SELECT $1, 'corporation', * FROM UNNEST(
                $2::INTEGER[],
                $3::VARCHAR[],
                $4::REAL[]
            )
