...
mod tests {
    ...
    async fn happy_path_all(
        ...
        let request = Request::builder()
            .uri("/00000000-0000-0000-0000-000000000001/industry-hubs")
            .method("GET")
    ...
    async fn happy_path_no_content(
        ...
        let request = Request::builder()
            .uri("/00000000-0000-0000-0000-000000000005/industry-hubs")
            .method("GET")
    ...
    async fn not_found(
        ...
        let request = Request::builder()
            .uri("/00000000-0000-0000-0000-000000000000/industry-hubs")
            .method("GET")
            .header(HEADER_CHARACTER_ID, 1)
            .header(HEADER_CORPORATION_ID, 1)
            .header(HOST, "test.starfoundry.space")
