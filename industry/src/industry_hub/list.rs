...
use starfoundry_lib_industry::IndustryHub;

use crate::{eve_gateway_api_client, AppState};
use crate::api_docs::{Forbidden, InternalServerError, Unauthorized};
use crate::industry_hub::error::Result;
use crate::industry_hub::service::{list, IndustryHubFilter};

/// List Industry Hubs
/// 
/// - Alternative route: `/latest/industry-hubs`
/// - Alternative route: `/v1/industry-hubs`
/// 
/// ---
/// 
...
#[utoipa::path(
    ...
    responses(
        (
            ...
            description = "All industry hubs the user has access to",
            status = OK,
        ),
        (
...
mod tests {
    ...
    async fn happy_path_all(
        ...
        let body: Vec<IndustryHub> = serde_json::from_slice(
